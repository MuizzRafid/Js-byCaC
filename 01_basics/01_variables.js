...
let accountGmail = "muizzrafid1@gmail.com";

accountCity = "panchagarh";
//an undeclared variable become global also if it in scope
console.log(accountId);

console.table([accountId, accountGmail, accountCity]);

// ** https://www.geeksforgeeks.org/javascript-variables/?ref=roadmap
